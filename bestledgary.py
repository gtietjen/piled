...
if __name__ == '__main__':
    ...
    light2 = datetime.now() + timedelta(seconds=0.15)
    light3 = datetime.now() + timedelta(seconds=0.3)
    light4 = datetime.now() + timedelta(seconds=0.45)
    light5 = datetime.now() + timedelta(seconds=0.6)
    light6 = datetime.now() + timedelta(seconds=0.75)
    light7 = datetime.now() + timedelta(seconds=0.9)
    light8 = datetime.now() + timedelta(seconds=1.1)
    light9 = datetime.now() + timedelta(seconds=1.25)
    light10 = datetime.now() + timedelta(seconds=1.4)
    light11 = datetime.now() + timedelta(seconds=1.55)
    light12 = datetime.now() + timedelta(seconds=1.70)
    light13 = datetime.now() + timedelta(seconds=1.85)
    light14 = datetime.now() + timedelta(seconds=2)
    light15 = datetime.now() + timedelta(seconds=2.15)
    light16 = datetime.now() + timedelta(seconds=2.3)
    light17 = datetime.now() + timedelta(seconds=2.45)
    light18 = datetime.now() + timedelta(seconds=2.6)
    light19 = datetime.now() + timedelta(seconds=2.75)
    light20 = datetime.now() + timedelta(seconds=2.9)
    light21 = datetime.now() + timedelta(seconds=3.05)
    light22 = datetime.now() + timedelta(seconds=3.2)
    light23 = datetime.now() + timedelta(seconds=3.35)
